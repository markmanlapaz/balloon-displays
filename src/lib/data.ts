...
export interface Product {
  ...
  badge?: string;
  inStock: boolean;
  category: 'arches' | 'garlands' | 'columns' | 'bouquets' | 'custom' | 'packages' | 'services' | 'add-ons';
...
export const allProducts: Product[] = [
  ...
  },
  {
    ...
    name: 'Extra Latex Balloons (10 pack)',
    description: 'Add 10 extra high-quality latex balloons in matching colors',
    longDescription: 'Enhance any balloon display with a pack of 10 extra premium latex balloons. Available in a wide range of colors, these balloons are perfect for filling out arches, garlands, or creating additional accent clusters. Each balloon is made from professional-grade natural latex for vibrant color and long float time. Mix and match colors to complement your existing order or event theme.',
    price: 12,
    image: '/images/large-balloon-bouquet.webp',
    images: ['/images/large-balloon-bouquet.webp'],
    inStock: true,
    ...
    type: 'product',
    features: [
      '10 premium latex balloons per pack',
      'Wide range of color options',
      'Professional-grade natural latex',
      'Mix of 11" and 5" sizes',
      'Great for filling out displays',
      'Long-lasting quality',
    ],
    reviews: [],
    addOns: [] as unknown as AddOn[],
  },
  {
    id: 'ao2',
    name: 'Foil Number Balloons',
    description: 'Large 34" foil number balloons, perfect for birthdays and anniversaries',
    longDescription: 'Make milestones unforgettable with our large 34-inch foil number balloons. Available in digits 0-9, these eye-catching balloons are perfect for birthdays, anniversaries, graduations, and New Year celebrations. Choose from gold, silver, rose gold, or a variety of other colors to match your event theme. Self-sealing valve makes inflation easy. Can be air-filled to use as a standing display or helium-filled to float.',
    price: 8,
    image: '/images/custom-printed-balloon.webp',
    images: ['/images/custom-printed-balloon.webp'],
    inStock: true,
    ...
    type: 'product',
    features: [
      'Large 34" size for maximum impact',
      'Available in digits 0-9',
      'Gold, silver, rose gold, and more',
      'Self-sealing valve',
      'Air-fill or helium-fill compatible',
      'Reusable if carefully deflated',
    ],
    reviews: [],
    addOns: [] as unknown as AddOn[],
  },
  {
    ...
    name: 'LED Balloon Lights (5 pack)',
    description: 'Battery-powered LED lights inside balloons for a glowing effect',
    longDescription: 'Create a magical atmosphere with our LED balloon lights. Each pack contains 5 battery-powered LED light inserts that fit inside standard latex balloons, transforming them into glowing orbs of light. Perfect for evening events, outdoor parties, and romantic settings. The warm white LEDs provide a soft, enchanting glow that lasts up to 24 hours on a single battery. Simply insert the light, inflate the balloon, and watch your event come alive.',
    price: 15,
    image: '/images/large-balloon-bouquet.webp',
    images: ['/images/large-balloon-bouquet.webp'],
    inStock: true,
    ...
    type: 'product',
    features: [
      '5 LED light inserts per pack',
      'Warm white glow',
      'Up to 24-hour battery life',
      'Fits standard latex balloons',
      'Waterproof design',
  ...
  },
  {
    ...
    name: 'Custom Banner Sign',
    description: 'Personalized vinyl banner up to 6ft with your message',
    longDescription: 'Add a personal touch to your balloon display with a custom vinyl banner. Each banner is up to 6 feet wide and features your personalized message printed in high-quality, weather-resistant vinyl. Choose from a range of fonts, colors, and design templates, or provide your own design. Perfect for birthdays ("Happy 30th!"), weddings ("Just Married"), corporate events (company branding), and more. Includes hanging hardware for easy attachment to balloon arches or garlands.',
    price: 35,
    image: '/images/event-balloon-package.webp',
    images: ['/images/event-balloon-package.webp'],
    inStock: true,
    ...
    features: [
      ...
      'Range of fonts and colors',
      'Includes hanging hardware',
      'Integrates with balloon displays',
    ],
    reviews: [],
    addOns: [] as unknown as AddOn[],
  },
  {
    ...
    name: 'Table Centerpiece',
    description: 'Balloon centerpiece arrangement for one table',
    longDescription: 'Elevate your table decor with our elegant balloon centerpiece arrangements. Each centerpiece features a curated cluster of balloons in varying sizes, anchored with a decorative weight base. Designed to complement your overall event design, these centerpieces add height and visual interest without blocking conversation across the table. Available in any color combination and can include foil accent balloons for added sparkle.',
    price: 25,
    image: '/images/large-balloon-bouquet.webp',
    images: ['/images/large-balloon-bouquet.webp'],
    inStock: true,
    ...
    type: 'product',
    features: [
      'Curated balloon cluster design',
      'Weighted decorative base',
      'Custom color matching',
      'Conversation-friendly height',
      'Foil accent options available',
  ...
  },
  {
    ...
    name: 'Confetti Balloons (5 pack)',
    description: 'Clear balloons filled with metallic confetti',
    longDescription: 'Add sparkle and excitement to your celebration with our confetti-filled balloons. Each pack includes 5 crystal-clear latex balloons pre-filled with metallic confetti in your choice of gold, silver, rose gold, or mixed colors. When inflated with helium, the confetti creates a stunning visual effect that catches the light beautifully. These balloons are a showstopper for photo ops and can be popped at the end of the event for a dramatic confetti release.',
    price: 10,
    image: '/images/custom-printed-balloon.webp',
    images: ['/images/custom-printed-balloon.webp'],
    inStock: true,
    ...
    type: 'product',
    features: [
      '5 clear balloons per pack',
      'Pre-filled metallic confetti',
      'Gold, silver, or rose gold options',
      'Eye-catching light-catching effect',
      'Perfect for photos',
      'Helium-fill recommended',
    ],
    reviews: [],
    addOns: [] as unknown as AddOn[],
  },
  {
    ...
    name: 'Ribbon & Tassel Kit',
    description: 'Decorative ribbons and tassels to accent your balloon display',
    longDescription: 'Take your balloon display to the next level with our decorative ribbon and tassel kit. Each kit includes a selection of satin ribbons, metallic streamers, and tissue paper tassels in coordinating colors. These accents add movement, texture, and elegance to any balloon installation — from garlands and arches to bouquets and columns. Our team can integrate these into your balloon order for a polished, finished look.',
    price: 18,
    image: '/images/balloon-garland.webp',
    images: ['/images/balloon-garland.webp'],
    inStock: true,
    ...
    type: 'product',
    features: [
      'Satin ribbons and metallic streamers',
      'Tissue paper tassels included',
      'Color-coordinated to your order',
      'Adds texture and movement',
      'Professional integration available',
      'Suits arches, garlands, and bouquets',
    ],
    reviews: [],
    addOns: [] as unknown as AddOn[],
  },
  {
    ...
    name: 'Flower Accent Garland',
    description: 'Silk flower accents woven into your balloon display',
    longDescription: 'Bring a touch of botanical elegance to your balloon installation with our silk flower accent garland. Premium silk flowers are artfully woven into your balloon garland or arch, creating a lush, garden-inspired display. Choose from roses, peonies, eucalyptus, or a custom mix to match your event style. The silk flowers add depth, color variation, and a refined aesthetic that elevates any balloon display into a true work of art.',
    price: 40,
    image: '/images/balloon-garland.webp',
    images: ['/images/balloon-garland.webp'],
    badge: 'Popular',
    ...
    features: [
      ...
      'Roses, peonies, eucalyptus, and more',
      'Woven into your balloon display',
      'Custom flower selection',
      'Adds botanical elegance',
      'Reusable silk flowers',
    ],
    reviews: [],
    addOns: [] as unknown as AddOn[],
  },
